...
# Sanity checks
if(DEFINED deedsBCV_DIR AND NOT EXISTS ${deedsBCV_DIR})
  message(FATAL_ERROR "deedsBCV_DIR [${deedsBCV_DIR}] variable is defined but corresponds to nonexistent directory")
endif()
...
if(NOT DEFINED ${proj}_DIR AND NOT ${SUPERBUILD_TOPLEVEL_PROJECT}_USE_SYSTEM_${proj})
  ...
  ExternalProject_SetIfNotDefined(
    ...
    "${EP_GIT_PROTOCOL}://github.com/sirfoga/deedsBCV.git"
    QUIET
  )
  ...
  ExternalProject_Add(${proj}
    ...
    CMAKE_CACHE_ARGS
      ...
      -DdeedsBCV_INSTALL_RUNTIME_DIR:STRING=${Slicer_INSTALL_THIRDPARTY_LIB_DIR}
      -DdeedsBCV_INSTALL_LIBRARY_DIR:STRING=${Slicer_INSTALL_THIRDPARTY_LIB_DIR}
